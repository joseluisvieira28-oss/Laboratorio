...
receipt={
 "lab_id":"CMM-002-V01",
 "gate":"HOLDOUT_SAFE_STABLECOIN_SOURCE_V01B",
...
path=os.path.join(OUT_DIR,"CMM002_STABLECOIN_SOURCE_GATE_V01B.json")
with open(path,"w",encoding="utf-8") as f:
    json.dump(receipt,f,indent=2,sort_keys=True,allow_nan=False)

md=[
 "# CMM-002 — HOLDOUT-SAFE STABLECOIN SOURCE GATE V0.1B",
 "",
...
with open(os.path.join(OUT_DIR,"CMM002_STABLECOIN_SOURCE_GATE_V01B.md"),"w",encoding="utf-8") as f:
    f.write("\n".join(md)+"\n")
