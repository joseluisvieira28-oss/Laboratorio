...
OUT = OUTDIR / "QBC_DISCOVERY_RESULT_V01.json"
...
def simulate_route(route, spot, fut, p):
    ...
    require_contiguous(spot, snapshot_ts, forced_ts, route["contract"] + ":spot")
    require_contiguous(fut, snapshot_ts, forced_ts, route["contract"] + ":future")
