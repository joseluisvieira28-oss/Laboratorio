#!/usr/bin/env python3
"""CED1D-0031 prospective shadow collector V0.2B.
...
FIRST_SIGNAL_DAY=date(2026,9,21)
FIRST_SIGNAL_COMPLETION=datetime(2026,9,22,0,0,tzinfo=timezone.utc)
FIRST_ENTRY_TS=int(datetime(2026,9,22,0,1,tzinfo=timezone.utc).timestamp()*1000)
...
def main():
    ...
    try:
        ...
        receipt={"document_id":"CED1D_0031_PROSPECTIVE_SHADOW_RECEIPT_V0.2B","status":status,
        ...
        (out/"CED1D_0031_PROSPECTIVE_SHADOW_RECEIPT_V0.2B.json").write_text(json.dumps(receipt,indent=2,sort_keys=True)+"\n")
