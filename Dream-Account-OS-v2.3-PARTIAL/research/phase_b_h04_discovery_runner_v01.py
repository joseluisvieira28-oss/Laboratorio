...
from research.phase_b_h04_binance_offline_adapter_v01 import TIMEFRAME_MS, adapt_h04_binance_daily_archive_bytes
...
EXPECTED_AUTHORIZATION_FINGERPRINT="bdc638bf5197d439bd09de6b008e1d88650cf3c79437582ab57c0f863d0cbc45"
EXPECTED_MANIFEST_FINGERPRINT="b7f5e4a1d10bade125e07b6b69f3f06ce0af0282fdde524e4e72bf055ec157af"
...
def run_h04(raw_root:Path, output_path:Path, authorization_path:Path=DEFAULT_AUTHORIZATION_PATH):
    auth=_load_auth(authorization_path); manifest=build_h04_manifest_receipt()
    ...
    bars={s:[] for s in auth['symbols']}; sha={}; integrity={'archives_expected':EXPECTED_ARCHIVE_COUNT,'archives_passed':0,'checksum_verified':0,'source_rows':0,'detected_internal_gap_count':0,'missing_candles_including_day_boundaries':0}
    for it in objs:
        ...
        integrity['archives_passed']+=1; integrity['checksum_verified']+=1; integrity['source_rows']+=ad.row_count; integrity['detected_internal_gap_count']+=ad.detected_gap_count; integrity['missing_candles_including_day_boundaries']+=total
