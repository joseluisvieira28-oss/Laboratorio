...
-- BIGQUERY LIQUIDATION CANDIDATE SMOKE TEST V0.2
-- READ-ONLY / SOURCE-ONLY / OUTCOME-BLIND
--
-- Technical-only revision from V0.1:
--   Replace the program-id CTE join in the table scan with a direct literal
--   program_id IN (...) predicate so BigQuery can prune the program_id cluster.
--   Scientific window, protocol IDs, discriminators and candidate semantics are
--   unchanged.
--
