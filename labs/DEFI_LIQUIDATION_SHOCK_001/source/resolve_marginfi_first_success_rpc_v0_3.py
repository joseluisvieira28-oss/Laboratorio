...
MAX_PAGES=5000
MAX_RETRIES=12
OUT=Path("dls_marginfi_rpc_boundary_v03")
...
state={
 "schema_version":"0.3","boundary_class":"MARGINFI","lab_id":"DEFI-LIQUIDATION-SHOCK-001",
...
for page_no in range(1,MAX_PAGES+1):
    ...
    if not page:
        ...
        write_json("DLS_MARGINFI_RPC_FIRST_SUCCESS_RECEIPT_V0.3.json",state)
