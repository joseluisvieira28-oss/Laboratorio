...
OUT=Path("dls_drift_early_upper_anchor_v02")
...
if target_slot is None:
    ...
    Path("labs/DEFI_LIQUIDATION_SHOCK_001/DRIFT_EARLY_UPPER_ANCHOR_RECEIPT_V0.2.json").write_text(json.dumps(receipt,indent=2,sort_keys=True)+"\n")
...
receipt={
  ...
  "technical_supersession":"getBlock transactionDetails full -> accounts",
      "technical_supersession":"getBlock transactionDetails full -> accounts",
  "calibration":calibration,
