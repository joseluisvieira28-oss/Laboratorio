...
ANCHOR_SIG="4og9qdwnR1hohhbSYuX45oCiYELdDW2rMWV1oPo2V9CLKEGVC6XVXqnaiJm9a7YV6QFwwK7YCj86A1pnME9d6c4c"
ANCHOR_SLOT=311143068
ANCHOR_TS=int(datetime.fromisoformat("2025-01-01T07:01:53+00:00").timestamp())
PAGE_LIMIT=1000
MAX_PAGES=5000
MAX_RETRIES=12
OUT=Path("dls_save0c_rpc_boundary_v01")
...
state={
 "schema_version":"0.1","boundary_class":"SAVE0C","lab_id":"DEFI-LIQUIDATION-SHOCK-001",
...
for page_no in range(1,MAX_PAGES+1):
    ...
    if not page:
        ...
        write_json("DLS_SAVE0C_RPC_FIRST_SUCCESS_RECEIPT_V0.1.json",state)
...
state.update(phase="COMPLETE_NO_MATCH",classification="SAVE0C_FIRST_SUCCESS_BOUNDARY_SOURCE_ANOMALY_FAIL_CLOSED",
