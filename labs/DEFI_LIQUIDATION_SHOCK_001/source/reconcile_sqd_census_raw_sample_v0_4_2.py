...
QUEUE=BASE/"KAMINO_SAVE11_RAW_SAMPLE_QUEUE_V0.4.2.json"
OUT=BASE/"KAMINO_SAVE11_RAW_SAMPLE_RECONCILIATION_RECEIPT_V0.4.2.json"
CFG={
...
def rpc(sig):
 ...
 req=urllib.request.Request(RPC,data=body,headers={"Content-Type":"application/json","User-Agent":"crypto-lab-dls-raw-sample/0.4.2"})
 last=None
 for i in range(10):
  try:
...
receipt={"schema_version":"0.4.2","lab_id":"DEFI-LIQUIDATION-SHOCK-001",
