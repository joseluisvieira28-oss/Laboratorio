...
ANCHOR_SIG="2MmsSBLJBdT5mwjNyn5HDKZc5hHXogNP9vSg53CzmXynN95REnyr973Lo6ZWqrthfBjYVw7RyTPTzFsUbS9uYv25"
ANCHOR_SLOT=260229711
ANCHOR_TS=int(datetime.fromisoformat("2024-04-15T08:32:05+00:00").timestamp())
ANCHOR_ERR=None
PAGE_LIMIT=1000
MAX_PAGES=5000
MAX_RETRIES=12
OUT=Path("dls_marginfi_rpc_boundary_v02")
...
state={
 "schema_version":"0.2","boundary_class":"MARGINFI","lab_id":"DEFI-LIQUIDATION-SHOCK-001",
 ...
 "continuation_parent_run_id":35715833295,
 "resume_cursor_extraction_run_id":35732854347,
 "resume_cursor_page_sha256":"874d519e3de696acda80946ec65fb860f92f9bd9dc50b8c884324c33e893e332",
...
for page_no in range(1,MAX_PAGES+1):
    ...
    if not page:
        ...
        write_json("DLS_MARGINFI_RPC_FIRST_SUCCESS_RECEIPT_V0.2.json",state)
...
state.update(phase="COMPLETE_NO_MATCH",classification="MARGINFI_FIRST_SUCCESS_BOUNDARY_RPC_NO_MATCH_IN_EARLIEST_SLICE",
