...
OUT=Path("eth_blockspace_full_source_v02_final")
...
def main()->int:
    ...
    rawp=OUT/"ETH_BLOCKSPACE_DEMAND_001_SAMPLED_BLOCKS_V0_2.csv"
    ...
    dailyp=OUT/"ETH_BLOCKSPACE_DEMAND_001_DAILY_SOURCE_SERIES_V0_2.csv"
    ...
    recp=OUT/"ETH_BLOCKSPACE_DEMAND_001_FULL_SOURCE_DATA_GATE_V0_2_RECEIPT.json"
