...
def main()->int:
    ...
    try:
        ...
        snaps=cal["snapshots"]; to_block=int(cal["replication_event_to_block"])
        ...
        # frozen 2024 event ceiling are canonical master identities but cannot
        ...
        meta={
            ...
            "safety":{
                ...
                "future_liquidation_outcomes_opened":False,"opened_2024_predictor":True,"opened_2024_outcomes":False,
