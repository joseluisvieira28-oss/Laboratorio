...
AUTHORITY = "AAVE_LIQUIDATION_OVERHANG_001_R1_GLOBAL_STREAM_TRANSPORT_REMEDIATION_V0_4_1"
...
def main() -> int:
    ...
    if stats is not None and set(stats) != set(PROVIDERS):
        ...
        x["failure"] = "V0.4.1 provider-set binding mismatch"
    else:
    ...
    x["stream_transport_hardening"] = {
        "partial_pages_discarded": True,
        "same_request_retried_on_requests_exception": True,
        "max_stream_attempts_per_page": 8,
