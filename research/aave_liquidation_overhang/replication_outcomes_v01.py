#!/usr/bin/env python3
"""Open only the frozen 2024 Aave LiquidationCall replication outcome after predictor persistence."""
...
def main()->int:
    ...
    try:
        ...
        start_block=blocks[0]; end_block=int(cal["replication_event_to_block"])
