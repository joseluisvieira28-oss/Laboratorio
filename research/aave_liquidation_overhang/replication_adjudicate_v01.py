...
def main()->int:
    ...
    try:
        ...
        if any(not str(x["date"]).startswith("2024-") for x in p):
            raise RuntimeError("non-2024 predictor row opened")
        ...
        receipt={
            ...
            "gates":gates,
            "next_authorized_phase":"SEPARATE_MARKET_IMPACT_MVE_PROTOCOL" if classification=="REPLICATION_MECHANISM_PASS_REQUIRES_SEPARATE_MARKET_MVE" else None,
