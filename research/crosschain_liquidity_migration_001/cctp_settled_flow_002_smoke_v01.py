...
OUT=Path("artifacts/cclm_cctp_settled_flow_002_smoke_v01.json")
...
receipt={"lab_id":"CROSSCHAIN-LIQUIDITY-MIGRATION-001","child_id":"CCLM-CCTP-SETTLED-FLOW-002",
 "stage":"SETTLED_FLOW_DESTINATION_SMOKE_V0.1","window":"2023-08-20 UTC","routes":[],
...
try:
    ...
    receipt["classification"]="SOURCE_SETTLED_FLOW_TECHNICAL_FAILURE";receipt["error"]=f"{type(e).__name__}:{str(e)[:800]}"
