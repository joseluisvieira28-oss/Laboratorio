...
OUT=Path("artifacts/cclm_cctp_v1_transport_smoke_v02.json")
PROBES=[
 ...
 {"name":"ethereum_mint_and_withdraw","rpc":"https://eth.drpc.org/","block":18433832,"address":"0xbd3fa81b58ba92a82136038b25adec7066af3155","topic":"0x1b2a7ff080b8cb6ff436ce0372e399692bbfb6d4ae5766fd8d58a7b8cc6142e6"},
]
def rpc(url,method,params):
    req=urllib.request.Request(url,data=json.dumps({"jsonrpc":"2.0","id":1,"method":method,"params":params}).encode(),headers={"Content-Type":"application/json","User-Agent":"CryptoLab-CCLM-001-Transport/0.2"},method="POST")
...
receipt={"lab_id":"CROSSCHAIN-LIQUIDITY-MIGRATION-001","child_id":"CCLM-CCTP-USDC-001","stage":"CCTP_V1_HISTORICAL_TRANSPORT_SMOKE_V0.2","captured_at_utc":datetime.now(timezone.utc).isoformat(),"classification":"HISTORICAL_RPC_TRANSPORT_PASS" if passed else "HISTORICAL_RPC_TRANSPORT_FAILURE","probes":rows,"market_outcomes_opened":False,"pnl_opened":False,"mutation":False,"access_2025":False,"access_2026":False}
