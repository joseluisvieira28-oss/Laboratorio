...
OUT=Path("artifacts/cclm_cctp_settled_flow_002_week_v01.json")
START_TS=int(datetime(2023,8,20,tzinfo=timezone.utc).timestamp())
END_TS=int(datetime(2023,8,27,tzinfo=timezone.utc).timestamp())-1
...
receipt={"lab_id":"CROSSCHAIN-LIQUIDITY-MIGRATION-001","child_id":"CCLM-CCTP-SETTLED-FLOW-002",
 "stage":"SETTLED_FLOW_7DAY_SOURCE_SCALE_V0.1","window":"2023-08-20 through 2023-08-26 UTC","routes":[],
...
try:
    ...
    receipt["classification"]="SOURCE_SETTLED_FLOW_7DAY_TECHNICAL_FAILURE";receipt["error"]=f"{type(e).__name__}:{str(e)[:800]}"
