...
def run_discovery() -> int:
    ...
    try:
        ...
        gates = {
            ...
            "year_2023_ge_10_and_mean_nonnegative": by_year["2023"]["count"] >= 10 and (by_year["2023"]["mean_base_net_eth"] or -1) >= 0,
            "year_2024_ge_10_and_mean_nonnegative": by_year["2024"]["count"] >= 10 and (by_year["2024"]["mean_base_net_eth"] or -1) >= 0,
