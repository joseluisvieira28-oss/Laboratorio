...
OUT=Path(f"artifacts/lcod_full_census_group_{GROUP}_v01.json")
TOL=5e-5
...
receipt={
 ...
 "stage":"FULL_CENSUS_GROUP_SOURCE_PREFLIGHT_V0.1",
 ...
 "classification":"GROUP_SOURCE_PREFLIGHT_PASS" if passed else "GROUP_SOURCE_PREFLIGHT_BLOCKED",
