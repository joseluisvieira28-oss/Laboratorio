...
async function rpc(method,params){
 const r=await fetch(RPC,{method:'POST',headers:{'content-type':'application/json','user-agent':'CryptoLab-LCOD-ActivePrep/0.7'},body:JSON.stringify({jsonrpc:'2.0',id:1,method,params})})
...
const out={stage:'BLOCK_PINNED_ACTIVE_POPULATION_PREP_V0.7',classification:include.length===16?'PREP_PASS':'PREP_BLOCKED',
...
await mkdir('artifacts',{recursive:true});await writeFile('artifacts/lcod_active_population_prepare_v07.json',JSON.stringify(out,null,2)+'\n')
