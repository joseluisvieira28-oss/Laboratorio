...
class ETFCMEInstFlowAdapter(StrategyAdapter):
    ...
    Scientific logic stays in etf_cme_instflow_001.py and etf_cme_source.py.
    This adapter only binds that frozen logic to the radar registry, constrains it
    to BTCUSDT, and caches slow-moving public CFTC rows operationally.
    """
